...
class LoveYou():
	...
	def __init__(self):
		...
		self.list=["刘家淇","张浩楠","吴玉泽","马宇星","董帅","崔睿","曹宗亮","邢凯","李壮壮","邵广超","靳颜昆","石现龙","李冰","张自豪","杨亚明","王学文","臧一凡","温思思","李宁","柴子建","冯帅","李爽","王哲","李依哲","马成超","张伟","王伟录","常瑞贤","李宜航","赵伟奇","张益哲"]
		#第2步，给窗口的可视化起名字
	...
	def main(self):
		...
		l.config(font = 'Helvetica -%d bold' % 30)
